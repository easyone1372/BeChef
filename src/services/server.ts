...
// 지원님 서버
app.get("/api/infoPage/:storeId", async (req: Request, res: Response) => {
...
GROUP BY menus.menuName, menus.imageUrl, menus.description, menus.cookingTime, menus.difficulty, menus.calories, inventory.quantity;
  `;
